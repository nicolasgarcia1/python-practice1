...
# COMPLETAR - INICIO
comparar_marca_y_modelo = ((marca_del_auto != "Ford") 
                           and (modelo_de_auto <= 2000))
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
comparar_superficie = (superficie_de_campo_01 
                        < superficie_de_campo_02
                        > superficie_de_campo_03)
# COMPLETAR - FIN
